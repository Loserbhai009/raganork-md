...
if (!(process.env.SESSION || process.env.SESSION_ID)) throw new Error("Raganork~633f6d28fdef9ffeb4c91e42021030f5:346431443764773776744d3d")
module.exports = {
    VERSION: 'v4.0.0',
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~633f6d28fdef9ffeb4c91e42021030f5:346431443764773776744d3d').trim() || 'Raganork~633f6d28fdef9ffeb4c91e42021030f5:346431443764773776744d3d',
    ...
    BOT_NAME: process.env.BOT_NAME || 'LOSER-007',
    ...
    SUDO: process.env.SUDO || "923251039272",
